  ...
  return (
    <footer>
      <div className="container footer-container">
        <ul className='foooter-categories'>
          ...
          <li><Link to={'/posts/categories/Science '}>Science </Link></li> <li><Link to={'/posts/categories/Weather'}>Weather</Link></li>
        </ul>

        <div className="footer-copyright">
          <small> &copy; Copyright All Rights Reserved || AKogman (Fullstack Dev)</small>
        </div>
      </div>      
    </footer>
  )
